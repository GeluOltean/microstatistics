...
class GraphBuilder(object):
    def __init__(self, df: pandas.DataFrame, labels: list, savelocation:str):
        self.df = df.copy()
        self.labels = labels
    ...
    def graphPercentages(self, index: int, title: str):
        holder = self.__df_proportion(self.df.copy())
    ...
    def graphMorphogroups(self, saveloc: str, labels: list):
        holder = self.__df_proportion(self.df.copy())
    ...
    def graphEpiInfDetailed(frame, saveloc: str):
        ...
        as input. """
        holder = self.__df_proportion(frame) * 100
    ...
    def __df_proportion(self, frame: pandas.DataFrame):
        holder = self.df.copy()
