...
class Table_Window(object):
    def setupUi(self, Table_Window):
        ...
        self.hurl_spin.setMaximum(99999)
        self.hurl_spin.setMinimum(1)
        self.hurl_spin.setValue(100)
        ...
        self.mainToolBar = QtWidgets.QToolBar(Table_Window)
        self.mainToolBar.setGeometry(QtCore.QRect(0, 0, 1108, 29))
        self.mainToolBar.setObjectName("mainToolBar")
        self.menuAbout = QtWidgets.QAction("About", self.mainToolBar)
        self.menuManual = QtWidgets.QAction("Manual", self.mainToolBar)
        Table_Window.addToolBar(self.mainToolBar)
        self.mainToolBar.addAction(self.menuAbout)
        self.mainToolBar.addAction(self.menuManual)
