...
class Ui_Table_Window(object):
    def setupUi(self, Table_Window):
        ...
        self.checkBox_7.setGeometry(QtCore.QRect(10, 10, 106, 29))
        self.checkBox_7.setObjectName("checkBox_7")
        self.checkBox_8 = QtWidgets.QCheckBox(self.page_2)
        self.checkBox_8.setGeometry(QtCore.QRect(10, 50, 106, 29))
        ...
        self.checkBox_9.setGeometry(QtCore.QRect(10, 10, 106, 29))
        self.checkBox_9.setObjectName("checkBox_9")
        self.checkBox_10 = QtWidgets.QCheckBox(self.page_3)
        self.checkBox_10.setGeometry(QtCore.QRect(10, 50, 106, 29))
        self.checkBox_10.setObjectName("checkBox_10")
        self.checkBox_11 = QtWidgets.QCheckBox(self.page_3)
        self.checkBox_11.setGeometry(QtCore.QRect(10, 90, 106, 29))
        self.checkBox_11.setObjectName("checkBox_11")
        self.checkBox_12 = QtWidgets.QCheckBox(self.page_3)
        self.checkBox_12.setGeometry(QtCore.QRect(10, 130, 106, 29))
        self.checkBox_12.setObjectName("checkBox_12")
        self.checkBox_13 = QtWidgets.QCheckBox(self.page_3)
        self.checkBox_13.setGeometry(QtCore.QRect(10, 170, 106, 29))
    ...
    def retranslateUi(self, Table_Window):
        ...
        self.checkBox_7.setText(_translate("Table_Window", "CheckBox"))
        self.checkBox_8.setText(_translate("Table_Window", "CheckBox"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("Table_Window", "Counts, multivariate"))
        self.checkBox_9.setText(_translate("Table_Window", "CheckBox"))
        self.checkBox_10.setText(_translate("Table_Window", "CheckBox"))
        self.checkBox_11.setText(_translate("Table_Window", "CheckBox"))
        self.checkBox_12.setText(_translate("Table_Window", "CheckBox"))
        self.checkBox_13.setText(_translate("Table_Window", "CheckBox"))
